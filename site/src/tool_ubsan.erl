...
-define(OUTPUT_ID, ubsan).
-define(FULLNAME, "Undefined Behaviour Sanitizer").
-define(COMPILER_ID, ubsan_compiler).
-define(COMPILER_CMD, "clang").
-define(COMPILER_OPTS, "-Idata/include -g -O0 -std=c99 -fsanitize=undefined,unsigned-integer-overflow,nullability-arg,nullability-assign,nullability-return").% -fPIE -fno-omit-frame-pointer -DTESTING").
-define(TOOL_CMD, "").
-define(TOOL_OPTS, "").
-define(EXEC_PANEL, ubsan_exec).
-define(COMPILE_PANEL, ubsan_compile).
-define(COMPILE_COMMAND_PANEL, ubsan_compile_command).
