...
-define(OUTPUT_ID, asan).
-define(FULLNAME, "Address Sanitizer (gcc)").
-define(COMPILER_ID, asan_compiler).
...
-define(TOOL_CMD, "").
-define(TOOL_OPTS, "").
-define(EXEC_PANEL, asan_exec).
-define(COMPILE_PANEL, asan_compile).
-define(COMPILE_COMMAND_PANEL, asan_compile_command).
