...
void global_array_pointer_before(uint32_t runtime_0_uint, const uint32_t array[]) { /* ERROR_FUNC */
  uint32_t val;
...
int main(int runtime_1_int, char* argv[]) {
  ...
  global_array_pointer_before((uint32_t)runtime_1_int - 1, module_const_array_array); /* ERROR_FUNC */
  return 0;
}
