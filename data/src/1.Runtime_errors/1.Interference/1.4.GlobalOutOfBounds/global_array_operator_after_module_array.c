...
void global_array_operator_after(uint32_t runtime_0_uint, uint32_t array[]) { /* ERROR_FUNC */
  uint32_t val;
...
int main(int runtime_1_int, char* argv[]) { (void) argv;
  module_array_Init();
  global_array_operator_after((uint32_t)runtime_1_int - 1, module_array_array); /* ERROR_FUNC */
  return 0;
}
