...
void stack_as_pointer_through_pointer_after(uint32_t runtime_0_uint) { /* ERROR_FUNC */
...
int main(int runtime_1_int, char* argv[]) { 
  (void) argv;
  stack_as_pointer_through_pointer_after((uint32_t) runtime_1_int - 1); /* ERROR_FUNC */
  return 0;
}
